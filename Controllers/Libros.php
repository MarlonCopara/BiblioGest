...
class Libros extends Controller
{
    ...
    public function registrar()
    {
        ...
        if (empty($titulo) || empty($autor) || empty($editorial) || empty($categoria) || empty($cantidad)) {
            ...
            if ($id == "") {
                $data = $this->model->insertarLibros($titulo, $autor, $editorial, $categoria, $cantidad, $num_pagina, $anio_edicion, $descripcion, $imgNombre);
                if ($data == "ok") {
                    if (!empty($name)) {
                ...
                $data = $this->model->actualizarLibros($titulo, $autor, $editorial, $categoria, $cantidad, $num_pagina, $anio_edicion, $descripcion, $imgNombre, $id);
                if ($data == "modificado") {
                    if (!empty($name)) {
                        move_uploaded_file($tmpName, $destino);
                    }
