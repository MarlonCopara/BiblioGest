...
<body class="app sidebar-mini">
    ...
    <header class="app-header"><a class="app-header__logo" href="<?php echo base_url; ?>Configuracion/admin">Gestión Bibliotecaria</a>
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <li><a class="app-menu__item" href="<?php echo base_url; ?>Categoria"><i class="app-menu__icon fa fa-list-alt"></i><span class="app-menu__label">Categorías</span></a></li>
