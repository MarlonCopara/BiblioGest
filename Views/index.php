        ...
        <div class="login-box">
            <form class="login-form" id="frmLogin" onsubmit="frmLogin(event);">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="Ingrese su usuario" id="usuario" name="usuario" autofocus required>
                </div>
                <div class="form-group">
                    <label class="control-label">CONTRASEÑA</label>
                    <input class="form-control" type="password" placeholder="Ingrese su contraseña" id="clave" name="clave" required>
                </div>
